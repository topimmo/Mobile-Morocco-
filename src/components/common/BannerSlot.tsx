        ...
        <div className={cn(
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div className="text-center">
              <p className="text-white md:text-white font-bold text-sm md:text-lg bg-white/95 md:bg-transparent text-[#222] md:text-white px-[10px] md:px-0 py-[6px] md:py-0 rounded-lg md:rounded-none">
