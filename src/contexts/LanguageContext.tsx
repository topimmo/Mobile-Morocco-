...
const translations: Record<string, Record<string, string>> = {
  ar: {
    ...
    'auth.confirmationSent': 'تم إرسال رسالة تأكيد جديدة. يرجى التحقق من صندوق الوارد ومجلد البريد العشوائي.',
  ...
  fr: {
    ...
    'auth.confirmationSent': 'Un nouvel email de confirmation a été envoyé. Veuillez vérifier votre boîte de réception et votre dossier spam.',
  ...
  en: {
    ...
    'auth.confirmationSent': 'A new confirmation email has been sent. Please check your inbox and spam folder.',
